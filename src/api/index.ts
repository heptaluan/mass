...
export function logout() {
  return normalAPIFormat(`/sys-user/logout`, null, 'POST', 'application/x-www-form-urlencoded');
}
...
export function getUploadFileList(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/uploadFileList`, params, 'POST')
}
export function findFromPACS(params: any) {
  return normalAPIFormat(`/aivd-dicom-study/findFromPACSByKeyword`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function syncFromPACS(params: any) {
  return normalAPIFormat(`/aivd-dicom-study/syncFromPACS`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getAnalysisResult(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/getAnalysisResult`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function restoreDicomByStudyUid(params: any) {
  return normalAPIFormat(`/aivd-dicom-study/restoreDicomByStudyUid`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function queryAllByStudyUid(params: any) {
  return normalAPIFormat(`/aivd-dicom-series/queryAllByStudyUid`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function getSelectionsByType() {
  return normalAPIFormat(`/sys-dict-item/getAllItemsList`, null, 'POST', 'application/x-www-form-urlencoded')
}
export function getBySeriesUid(params: any) {
  return normalAPIFormat(`/aivd-dicom-series/getBySeriesUid`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function findNoduleBySeriesUId(params: any) {
  return normalAPIFormat(`/aivd-nodule/findBySeriesUId`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function deleteNodule(params: any) {
  return normalAPIFormat(`/aivd-nodule/delete`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function uploadFile(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/uploadFile`, params, 'POST', 'multipart/form-data')
}
export function checkMd5(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/checkMd5`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function getTaskInfo(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/getTaskInfo`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function preSignUploadUrl(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/preSignUploadUrl`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function mergeFile(params: any) {
  return normalAPIFormat(`/aivd-dicom-archive-task/merge`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getDeptTree(params: any) {
  return normalAPIFormat(`/sys-dept/getDeptTree`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function findCurrentDepartment(params: any) {
  return normalAPIFormat(`/sys-dept/findByParentId`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function deleteDept(params: any) {
  return normalAPIFormat(`/sys-dept/delete`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function getParentIds(params: any) {
  return normalAPIFormat(`/sys-dept/getParentIds`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getRoleList() {
  return normalAPIFormat(`/sys-role/queryAllRoles`, null, 'POST','application/x-www-form-urlencoded')
}

export function switchStatus(params: any) {
  return normalAPIFormat(`/sys-user/switchStatus`, params, 'POST','application/x-www-form-urlencoded')
}

export function resetPassword(params: any) {
  return normalAPIFormat(`/sys-user/resetPassword`, params, 'POST','application/x-www-form-urlencoded')
}

export function importUsers(params: any) {
  return normalAPIFormat(`/sys-user/importUsers`, params, 'POST', 'multipart/form-data')
}

// 按id查询用户信息
export function findUserById(params: any) {
  return normalAPIFormat(`/sys-user/findUserById`, params, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getAllCtParam() {
  return normalAPIFormat(`/sys-param-ct/getAllCtParam`, null, 'POST','application/x-www-form-urlencoded')
}
...
export function parametersDelete(params: any) {
  return normalAPIFormat(`/sys-param-ct/delete`, params, 'POST', 'application/x-www-form-urlencoded')
}
export function setParametersDefault(params: any) {
  return normalAPIFormat(`/sys-param-ct/setDefault`, params, 'POST', 'application/x-www-form-urlencoded')
}

// deepLearning

export function getAiServer() {
  return normalAPIFormat(`/sys-config/getAiServer`, null, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getPACSServer() {
  return normalAPIFormat(`/sys-config/getPACSServer`, null, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getFileStorage() {
  return normalAPIFormat(`/sys-config/getFileStorage`, null, 'POST', 'application/x-www-form-urlencoded')
}
...
export function getNetworkSecurity(params: any) {
  return normalAPIFormat(`/sys-config/getNetworkSecurity`, null, 'POST', 'application/x-www-form-urlencoded')
}
...
export function deleteWhiteList(params: any) {
  return normalAPIFormat(`/sys-config/deleteWhiteList`, params, 'POST', 'application/x-www-form-urlencoded')
}
// log
...
export function uploadAuthorization(params: any) {
  return normalAPIFormat(`/sys-config/uploadLicenseCertification`, params, 'POST', 'multipart/form-data')
}
...
export function sendSMSVerificationCode(params: any) {
  ...
  return normalAPIFormat(`/tailai-cloud-system/sys-user/sendSMSVerificationCode`, smsParams, 'POST', 'application/json')
}
...
function normalAPIFormat(url: any, params: any, method: any, type?: any) {
  if (url === '/aivd-fusion-task/calculate') {
    return useAxiosApi(url, {
      method: method,
      data: (type && type !== 'multipart/form-data') ? qs.stringify(params) : params,
      headers: {
    ...
    return useAxiosApi(url, {
      ...
      timeout: (type === 'multipart/form-data' || url === '/aivd-dicom-study/findFromPACSByKeyword') ? 100000 : 5000
    });
  }
}
