...
import getWorldWidthAndHeightFromTwoPoints from "@cornerstonejs/tools/dist/esm/utilities/planar/getWorldWidthAndHeightFromTwoPoints";
import {
  pointInEllipse,
  getCanvasEllipseCorners,
} from "@cornerstonejs/tools/dist/esm/utilities/math/ellipse";
...
class EllipticalROITool extends AnnotationTool {
  constructor(
    ...
    this.toolSelectedCallback = (evt, annotation) => {
      ...
      const target = document.querySelector(".active.clear");
      if (target) {
