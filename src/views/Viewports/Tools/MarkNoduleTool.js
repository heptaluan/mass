...
import drawMarkNoduleTips from "./drawMarkNoduleTips";
...
import getWorldWidthAndHeightFromCorners from "@cornerstonejs/tools/dist/esm/utilities/planar/getWorldWidthAndHeightFromCorners";
import {
  resetElementCursor,
  hideElementCursor,
...
import { RectangleROIAnnotation } from "@cornerstonejs/tools/dist/esm/types/ToolSpecificAnnotationTypes";
import {
 ...
 */
class MarkNoduleTool extends AnnotationTool {
  static toolName;
  ...
  renderAnnotation = (enabledElement, svgDrawingHelper) => {
    ...
    for (let i = 0; i < annotations.length; i++) {
      ...
      const textBoxUID = "1";
      const boundingBox = drawMarkNoduleTips(
        svgDrawingHelper,
        annotationUID,
        textBoxUID,
        textLines,
        ...
        {},
        {
          ...
          fontSize: this.getStyle(
            "textBoxFontSize",
            styleSpecifier,
            annotation
          ),
          // color: this.getStyle('textBoxColor', styleSpecifier, annotation),
          color: "#FFFCDE",
          shadow: this.getStyle("textBoxShadow", styleSpecifier, annotation),
...
MarkNoduleTool.toolName = "MarkNodule";
export default MarkNoduleTool;
