import AnnotationDisplayTool from "@cornerstonejs/tools/dist/esm/tools/base/AnnotationDisplayTool";
...
class ScaleOverlayTool extends AnnotationDisplayTool {
  constructor(
    ...
    this.computeCanvasScaleCoordinates = (
      canvasSize,
      canvasCoordinates,
      vscaleBounds,
      hscaleBounds,
      ...
      if (location == "top" || location == "bottom") {
        ...
        scaleCanvasCoordinates = [
          [
            canvasSize.width / 2 - worldDistanceOnCanvas / 2,
            vscaleBounds.height,
          ],
          [
            canvasSize.width / 2 + worldDistanceOnCanvas / 2,
        ...
        scaleCanvasCoordinates = [
          [
            hscaleBounds.width,
            canvasSize.height / 2 - worldDistanceOnCanvas / 2,
          ],
          [
            hscaleBounds.width,
            canvasSize.height / 2 + worldDistanceOnCanvas / 2,
    ...
    this.computeScaleBounds = (
      ...
      const locationBounds = {
        ...
        right: [-vReduction + 20, -hReduction + 20],
      };
      const canvasBounds = {
