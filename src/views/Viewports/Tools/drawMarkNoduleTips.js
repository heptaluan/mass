function drawMarkNoduleTips(
  ...
  const canvasBoundingBox = drawTips(
    svgDrawingHelper,
    annotationUID,
    textBoxUID,
    textLines,
...
function drawTips(
  ...
  const textGroupBoundingBox = drawSvgBox(
    svgDrawingHelper,
    annotationUID,
    textUID,
    textLines,
...
function drawSvgBox(
  ...
  if (existingTextGroup) {
    ...
    textGroup.setAttribute("transform", `translate(${x - 22} ${y - 35})`);
...
export default drawMarkNoduleTips;
