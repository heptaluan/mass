...
import { getToolGroup, getToolGroupForViewport, } from '@cornerstonejs/tools/dist/esm/store/ToolGroupManager';
import { addAnnotation, getAnnotations, removeAnnotation, } from '@cornerstonejs/tools/dist/esm/stateManagement/annotation/annotationState';
import { drawCircle as drawCircleSvg, drawHandles as drawHandlesSvg, drawLine as drawLineSvg, } from '@cornerstonejs/tools/dist/esm/drawingSvg';
...
import liangBarksyClip from '@cornerstonejs/tools/dist/esm/utilities/math/vec2/liangBarksyClip';
    ...
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            otherViewportAnnotations.forEach((annotation) => {
                ...
                vec2.scale(canvasVectorFromCenterStart, canvasUnitVectorFromCenter, otherViewportAnnotations.length === 2 ? canvasDiagonalLength * 0.02 : 0);
